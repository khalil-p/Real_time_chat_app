...
function Profile() {
  ...
  const handleImageUpload = (e) => {
    ...
    setFormData((prev) => ({
      ...prev,
      avatar: file, // keep file for FormData upload
    }));
  };
  ...
  return (
    <div className="min-h-scree pt-20 bg-gray-50">
      <div className="max-w-2xl mx-auto p-4 py-8">
        <div className="bg-white rounded-xl shadow-md p-6 space-y-8">
          <div className="text-center">
            <h1 className="mt-2 text-gray-800">Profile</h1>
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="relative">
              <img
                src={selectedImage || formData.avatar || "/avatar-holder.jpg"}
                alt="Avatar"
                className="w-32 h-32 rounded-full object-cover object-top border-4 border-gray-100"
              />
              <label
          ...
          <button
            ...
            className="w-full bg-blue-600  hover:bg-blue-700 text-white font-medium py-2  rounded-md transition duration-200 flex justify-around items-center gap-2"
          >
            {isUpdatingProfile ? (
              <>
          ...
          <div className="mt-6 bg-gray-50 border border-gray-200 rounded-xl p-6">
            ...
            <div className="space-y-3 tex-sm text-gray-600">
