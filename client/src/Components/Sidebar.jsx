    ...
    <aside className="h-full w-20 lg:w-72 border-r border-gray-200 flex flex-col transition-all duration-200 bg-white">
      ...
      <div className="border-b border-gray-200 w-full p-5">
        <div className="flex items-center gap-2">
          <Users className="w-5 h-6 text-gray-700" />
        ...
        <div className="mt-3 hidden lg:flex items-center gap-2">
          <label className="cursor-pointer flex items-baseline-last gap-2 text-sm text-gray-700">
            <input
              type="checkbox"
      ...
      <div className="overflow-y-auto w-full py-3">
          ...
          filteredUsers.map((user) => {
            return (
              <button
                ...
                className={`w-full p-3 flex items-center gap-3 transition-colors roubded-md ${
              ...
              >
                ...
                <div className="relative mx-auto lg:mx-0">
                  <img
                    src={user?.avatar?.url || "/avatar-holder.jpg"}
                    alt="/avatar-holder.jpg"
        ...
        {filteredUsers.length === 0 && (
          <div className="text-center text-gra py-4">No Online Users</div>
        )}
      </div>
    </aside>
  );
